vim.keymap.set("n", "a", "<cmd>lua require('harpoon.mark').add_file()<cr>", { desc = "Harpoon Add" })
vim.keymap.set("n", "m", "<cmd>lua require('harpoon.ui').toggle_quick_menu()<cr>", { desc = "Harpoon Marks" })
